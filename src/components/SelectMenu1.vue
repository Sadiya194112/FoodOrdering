  ...
  methods: {
    ...
    confirmOrder(){
      ...
      let currOrder = {
        ...
        servicCharge: this.serviceCharge,
    ...
    calculateCharges(){
      ...
      for(let i=0; i < this.selectedProductList.length; i++){
        ...
        let productOriginalPrice =  this.getProductList.find(item => item.id == this.selectListLength[i].id).price;   //selected item er original price ber korchi
